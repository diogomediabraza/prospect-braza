...
def extract_companies_pai(html: str, nicho: str, localidade: str) -> list[dict]:
        """
            Extract company listings from pai.pt HTML.
                pai.pt: company names in h2/h3 with href="/paginas/{id}-{slug}"
        Phone numbers as href="tel:XXXXXXXXX"
        """
            ...
            def scrape_paginas_amarelas(
                    ...
                    """
                        Scrape pai.pt for companies.
                            URL: https://www.pai.pt/searches?search%5Bquery%5D={nicho}
                                     &search%5Blocation_value%5D={localidade}&page={page}
                                         """
                    results: list = []
                    page = 1
